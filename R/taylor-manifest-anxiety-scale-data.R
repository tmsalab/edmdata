...
#'
#' @format
#' A `matrix` consisting of `r nrow(items_taylor_manifest_anxiety_scale)` rows and
#' `r ncol(items_taylor_manifest_anxiety_scale)` columns. Thus, there are
#' \eqn{N = `r nrow(items_taylor_manifest_anxiety_scale)`} subject responses
#' to \eqn{J = `r ncol(items_taylor_manifest_anxiety_scale)`} items.
#'
