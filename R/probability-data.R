...
#'
#' - `p101`:  A box contains 30 marbles in the following colors:
#'   8 red, 10 black, 12 yellow.  What is the probability that a randomly
#'   drawn marble is yellow?  **(0.40)**
#' - `p102`:  A bag contains 5-cent, 10-cent, and 20-cent coins.
...
#'   coin?  **(0.65)**
#' - `p103`:  A bag contains 5-cent, 10-cent, and 20-cent coins.
...
#'   a 20-cent coin?  **(0.55)**
#' - `p104`:  In a school, 40\% of the pupils are boys and 80\% of
...
#' - `p111`:  In a garage there are 50 cars.  20 are black and 10 are
...
#' - `p112`:  A box contains 20 marbles.  10 marbles are red, 6 are
